    ...
    <div>
      ...
      {orders.length === 0 ? (
        ...
        <div className="space-y-2">
          ...
          <div className="hidden md:grid md:grid-cols-[auto_1fr_auto_auto_auto_auto] text-xs tracking-widest uppercase text-charcoal/50 bg-cream px-4 py-3 border-b border-sand">
