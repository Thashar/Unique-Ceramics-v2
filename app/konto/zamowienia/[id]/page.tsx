  ...
  return (
    <div>
      ...
      {order.status !== "CANCELLED" && (
        <div className="rounded-xl bg-cream border border-sand p-6 mb-6">
      ...
      {order.trackingNumber && order.trackingCarrier && (
        <div className="rounded-xl bg-cream border border-clay/30 p-5 mb-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="rounded-xl bg-cream border border-sand p-5">
            <h3 className="text-xs tracking-widest uppercase text-clay mb-3 flex items-center gap-2">
