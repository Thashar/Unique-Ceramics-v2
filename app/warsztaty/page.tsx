...
const workshops = [
  {
    id: 1,
    icon: "🎂",
    title: "Warsztaty urodzinowe",
    description:
      "Wyjątkowe urodziny w towarzystwie gliny! Idealne dla grup od 4 osób. W trakcie warsztatu uformujecie własne wyroby z gliny, które po wypaleniu możecie odebrać lub wysłać pocztą.",
    duration: "3–4 godziny",
    maxPeople: "od 4 osób",
    price: 80,
    priceLabel: "od 80 zł / os.",
    level: "Każdy poziom",
    dates: [],
  },
  {
    ...
    description:
      "Niezapomniane wieczory panieńskie z ceramiką. Możliwość degustacji wina. Każda uczestniczka wychodzi z własnoręcznie wykonanym, unikatowym dziełem.",
    duration: "3–4 godziny",
    maxPeople: "od 4 osób",
    price: 100,
    priceLabel: "od 100 zł / os.",
    level: "Każdy poziom",
    dates: [],
  },
  {
    ...
    title: "Team Building",
    description:
      "Integracja przez ceramikę dla firm i grup zawodowych. Doskonała alternatywa dla standardowych eventów — kreatywna, angażująca i pełna niespodzianek.",
    duration: "Do ustalenia",
    maxPeople: "wycena indywidualna",
    price: 0,
  ...
  },
  {
    id: 4,
    icon: "🌿",
    title: "Warsztaty otwarte",
    description:
      "Regularne warsztaty dla osób indywidualnych. Poznasz podstawy pracy z gliną — toczenie na kole lub hand-building. Nie potrzebujesz żadnego doświadczenia.",
    duration: "3 godziny",
    maxPeople: "małe grupy",
    price: 90,
    priceLabel: "od 90 zł / os.",
    level: "Każdy poziom",
    dates: [],
  },
  {
    id: 5,
    icon: "👨‍👩‍👧",
    title: "Dla dzieci i rodzin",
    description:
      "Warsztaty dla dzieci od 8 lat i całych rodzin. Bezpieczne materiały, przystępna forma, mnóstwo frajdy i niepowtarzalne wspomnienia.",
    duration: "2–3 godziny",
    maxPeople: "rodziny i grupy",
    price: 60,
    priceLabel: "od 60 zł / os.",
    level: "Dzieci od 8 lat",
    dates: [],
  },
  {
    id: 6,
    ...
    description:
      "Podaruj komuś wyjątkowe doświadczenie! Vouchery na dowolny rodzaj warsztatów. Idealne na urodziny, imieniny, Dzień Matki lub po prostu z okazji.",
    duration: "według wybranego warsztatu",
    maxPeople: "dla 1 osoby lub pary",
    price: 80,
    priceLabel: "od 80 zł",
    level: "Każdy poziom",
    dates: [],
        ...
        <div className="bg-cream py-16 px-6 lg:px-10">
          <div className="max-w-3xl mx-auto text-center">
            <p className="text-charcoal/80 text-lg leading-relaxed">
              ...
              wszystkiego nauczę Cię od podstaw.
            </p>
          </div>
        </div>
            ...
            {workshops.map((w) => (
              <div key={w.id} className="grid grid-cols-1 lg:grid-cols-3 gap-10 border-b border-sand pb-12 last:border-0 last:pb-0">
                <div className="lg:col-span-2">
                  ...
                  {w.dates.length > 0 && (
                    <div>
                      <p className="text-xs tracking-widest uppercase text-clay mb-3">Dostępne terminy</p>
                      <div className="flex flex-wrap gap-2">
                        {w.dates.map((date) => (
                          <span
                            key={date}
                            className="text-sm border border-sand px-4 py-2 text-charcoal/80"
                          >
                            {date}
                          </span>
                        ))}
                ...
                <div className="bg-cream p-8 self-start">
                  ...
                  <Link
                    href="/kontakt"
                    className="block text-center bg-terracotta hover:bg-clay text-warm-white text-xs tracking-widest uppercase py-4 transition-colors"
                  >
                    Zarezerwuj
                  </Link>
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-4 max-w-3xl mx-auto">
              {[
                ...
                <div key={item} className="bg-warm-white p-5 text-center text-sm text-charcoal/80 leading-relaxed">
                  {item}
                </div>
              ))}
            </div>
