...
- **Kategorie sklepu nie mają własnych adresów** – `/sklep?kategoria=kubki` canonicalizuje się
  do `/sklep`. To świadomy stan (brak duplikatów), ale i największa niewykorzystana szansa:
  landing page'e pod „kubki ceramiczne”, „świeczniki ceramiczne” itd. wymagają osobnego routingu
  i treści wstępów.
