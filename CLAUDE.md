...
| `/admin/kody-rabatowe`, `/admin/kody-rabatowe/nowy`, `/admin/kody-rabatowe/[id]` | Kody rabatowe (CRUD). Lista pokazuje stan (Działa / Zaplanowany / Zakończony / Wyłączony), procent, sposób łączenia, okno czasu i licznik użyć; bez tabeli w bazie – instrukcja migracji zamiast listy |
