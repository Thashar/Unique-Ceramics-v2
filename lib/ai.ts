 ...
 * 16:9 (Full HD, 1920×1080), więc wynik ma być zawsze poziomy w tych proporcjach:
 * pionowe albo kwadratowe zdjęcie źródłowe przekomponowujemy przez dołożenie tła
 * po bokach, nie przez obcięcie ani rozciągnięcie produktu. Proporcje podajemy
 * wprost (16:9 i 1920×1080) – „mniej więcej poziomo” model potrafił odczytać
 * jako kwadrat, co widać było w wariancie „AI+”.
 */
const ORIENTATION_RULE = `OUTPUT FORMAT IS MANDATORY: the generated image must always be HORIZONTAL, in a wide 16:9 landscape frame with Full HD proportions - 1920 x 1080 pixels, width to height ratio exactly 16:9, clearly wider than it is tall. Never return a square (1:1), vertical (portrait) or 4:3 image, whatever the shape of the original photo. If the original is vertical or square, recompose the shot into that wide 16:9 frame by extending the background and the surface to the left and right of the product - never by cropping any part of the ceramic, never by stretching, squashing or rotating it, and never by adding black bars, letterboxing or borders. The whole product stays visible, upright and correctly proportioned, with comfortable margins around it.`;
