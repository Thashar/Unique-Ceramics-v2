  ...
  return (
    <div className="mt-4 space-y-2">
      <button
        onClick={handleClick}
        disabled={loading}
        className="w-full flex items-center justify-center gap-2 bg-clay hover:bg-terracotta hover:text-espresso disabled:opacity-60 text-warm-white text-xs tracking-widest uppercase py-3 transition-colors rounded-md"
      >
