    ...
    <section className="relative bg-espresso overflow-hidden px-6 h-full flex flex-col justify-center pt-24 pb-16 lg:pt-28 lg:pb-20">
      ...
      >
        ...
        <a
          ...
          className="group inline-flex items-center gap-3 border border-terracotta/50 hover:border-terracotta hover:bg-terracotta hover:text-espresso text-cream text-sm tracking-widest uppercase px-8 py-4 transition-all duration-300 rounded-md"
        >
