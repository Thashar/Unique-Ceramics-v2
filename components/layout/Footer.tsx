...
export default function Footer({ compact = false }: { compact?: boolean }) {
  if (compact) {
    return (
      <footer className="bg-espresso text-sand/80 h-full flex flex-col">
        {/* Kompaktowa wersja dla snap-section pełnoekranowej */}
        <div className="flex-1 flex items-center">
          <div className="max-w-7xl mx-auto px-6 lg:px-10 py-6 w-full grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-10">
            {/* Marka */}
