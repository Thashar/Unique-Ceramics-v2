...
/**
 * Klucze ustawień, które mają angielską wersję, per zakładka. Pole angielskie
 * zapisuje się pod `en_{klucz}` (patrz `lib/i18n-content.ts`); puste = strona
 * `/en` pokazuje polski oryginał albo angielski domyślny z kodu.
 */
